...
typedef struct MEM_EXTENDED_PARAMETER_2 {
  struct {
	DWORD64 Type;
	DWORD64 Reserved;
  } DUMMYSTRUCTNAME;
...
} MEM_EXTENDED_PARAMETER_2, *PMEM_EXTENDED_PARAMETER_2;

typedef ULONG SE_SIGNING_LEVEL_2, *PSE_SIGNING_LEVEL_2;
...
EXTERN_C NTSTATUS NtCreateSectionEx(
	...
	IN PMEM_EXTENDED_PARAMETER_2 ExtendedParameters,
...
EXTERN_C NTSTATUS NtGetCachedSigningLevel(
	IN HANDLE File,
	OUT PULONG Flags,
	OUT PSE_SIGNING_LEVEL_2 SigningLevel,
...
EXTERN_C NTSTATUS NtSetCachedSigningLevel(
	IN ULONG Flags,
	IN SE_SIGNING_LEVEL_2 InputSigningLevel,
	IN PHANDLE SourceFiles,
	IN ULONG SourceFileCount,
	IN HANDLE TargetFile OPTIONAL);
